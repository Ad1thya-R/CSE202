...
def test_Q7(verbose, longTests, epsilon):
    ...
    if longTests:
        ...
        if count > 15766:
            ...
            print(f"It seems that your backtracking_search_help() function is called too few times, {count} instead of 15766")
        return result
    else:
        ...
        if count > 158:
            ...
            print(f"It seems that your backtracking_search_help() function is called too few times, {count} instead of 158")
        return result
