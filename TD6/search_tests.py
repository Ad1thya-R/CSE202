...
def test1():
    ...
    P = 'abra'
    T = 'abracadabra'
    print("Testing T= ", T, ", P = ", P, ": 2 matches at positions 0 and 7.")
    pos = string_match(T,P)
...
def test4():
    print("\nTesting karp_rabin_sum")
    P = 'abra'
    T = 'abacaaabra'
    x = karp_rabin_sum(T,P)
    if(x is None):
        print("karp_rabin_sum unimplemented")
        return
    ...
    P = 'abra'
    T = 'abracaaabra'
    print("Testing T= ", T, ", P = ", P, ": 2 matches at positions 0 and 7, 1 false hit.")
    pos,fh = karp_rabin_sum(T,P)
...
def test5():
    print("\nTesting karp_rabin_mod")
    Q = 181
    print("Prime:", Q)
    P = 'abra'
    T = 'abacaaabra'
    x = karp_rabin_mod(T,P,Q)
    if(x is None):
        print("karp_rabin_mod unimplemented")
        return
    ...
    P = 'abra'
    T = 'abracaaabra'
    print("Testing T= ", T, ", P = ", P, ": 2 matches at positions 0 and 7, 0 false hit.")
    pos,fh = karp_rabin_mod(T,P,Q)
